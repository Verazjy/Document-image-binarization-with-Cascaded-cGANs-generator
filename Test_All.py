...
def Generator_G1(netName,AB_path,save_path):
    opt.name = netName
...
def Generator_G2(netName_2,input_path,save_path2):
    opt.name = netName_2
    model = create_model(opt)
    model.setup(opt)
...
if __name__ == '__main__':
    ...
    Generator_G1(Netname1, AB_path, save_path)
    print('The result of G1 has been generated')
    Generator_G2(Netname2, save_path, save_path)
    print('The result of G2 has been generated')

    # dir_AB = os.path.join(opt.dataroot, opt.phase)
    # splits = os.listdir(dir_AB)
    # for sp in splits:
    #     AB_path = os.path.join(dir_AB, sp)
    #     save_path1 = os.path.join(dir_AB, 'result1', sp)
    #     save_path2 = os.path.join(dir_AB, 'result2', sp)
    #     Generator_G1(Netname1, AB_path, save_path1)
    #     Generator_G2(Netname2, save_path1, save_path2)
