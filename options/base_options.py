...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', default=r'D:\learngit\pytorch-CycleGAN-and-pix2pix-Sub\datasets\Binary\DataHowMany/', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        self.parser.add_argument('--name', type=str, default='G2_1222', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--Input_path', dest='Input_path', help='input directory for image', type=str,
                            default=r'D:\learngit\pytorch-CycleGAN-and-pix2pix-Sub\datasets\Binary\DataHowMany\test')
        self.parser.add_argument('--Output_path', dest='Output_path', help='output directory for image', type=str,
                            default=r'D:\learngit\pytorch-CycleGAN-and-pix2pix-Sub\datasets\Binary\DataHowMany\test\result2')
